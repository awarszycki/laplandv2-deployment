...
export default function ProjectSelector({ onSelectProject }) {
  ...
  return (
    <div className="login-screen">
      ...
      <div className="login-sub">Zarządzanie wyprawami zimowymi i trekkingiem</div>

      <div style={{ width: "100%", maxWidth: "480px", display: "flex", flexDirection: "column", gap: "16px", zIndex: 10 }}>

        {projects.length > 0 && (
          <div className="login-card">
            <span className="login-label">Twoje aktywne wyprawy</span>
        ...
        {!showForm ? (
          ...
          <div className="login-card animate-fade-in">
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                placeholder="np. Sarek Trekking 2026"
                value={name}
                autoFocus
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                placeholder="np. Przejście północne, 14 dni autonomii"
                value={desc}
